...
project = u'Affine'
copyright = u'2013, Jan Šartner, FSV ČVUT'
...
latex_documents = [
  ('index', 'Affine.tex', u'Affine Documentation',
   u'Jan Šartner, FSV ČVUT', 'manual'),
]
...
man_pages = [
    ('index', 'TemplateClass', u'Affine Documentation',
     [u'Jan Šartner, FSV ČVUT'], 1)
]
